...
# Question 4
# Round numbers to 2 decimal places using custom map
numbers = [3.56773, 5.57668, 4.00914, 56.24241, 9.01344, 32.12013, 23.22222, 90.09873, 45.45, 314.1528, 2.71828, 1.41546]

def round10s(item):
    return round(item, 2)

print(*map(round10s, numbers), sep="\n")

# Question 5
# Filter 3-digit numbers ending with 2 modulo 5 and cube them
...
def isValid1(number):
    return 100 <= number < 1000 and number % 5 == 2

def cube(number):
    return number ** 3

print(*map(cube, filter(isValid1, numbers)), sep="\n")
...
def square1(initial, number):
    return initial + number ** 2

print(reduce(square1, numbers, 0))

# Question 7
# Sum of squares of numbers that are 2-digit multiples of 7
...
def isValid2(number):
    return 10 < abs(number) < 100 and number % 7 == 0

def square2(number):
    return number ** 2
    
print(sum(map(square2, filter(isValid2, numbers))))
